...
include 'delete_despicableme2.php';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_SESSION['user_id'])) {
        ...
        if (!empty($komentar)) {
            ...
            $query = "INSERT INTO despicableme2_review (komentar, bintang, user_id) VALUES (:komentar, :bintang, :user_id)";
...
if (isset($_SESSION['user_id'])) {
    $user_id = $_SESSION['user_id'];
    $query = "SELECT er.*, u.username FROM despicableme2_review er JOIN users u ON er.user_id = u.id ORDER BY er.tanggal DESC";
    $stmt = $conn->prepare($query);
    $stmt->execute();
...
try {
    $avgQuery = "SELECT AVG(bintang) AS rata_rata_bintang FROM despicableme2_review";
...
<head>
    ...
    <link rel="stylesheet" href="/Film/Despicable Me 2/despicableme2.css">
</head>
...
<header>
    ...
    <div class="main-content">
        ...
        <div class="details">
            ...
            <div class="year">2013, Chris Renaud & Pierre Coffin</div>
            ...
            <br>
            <p class="synopsis">
                A good villain and his team investigate a villain who is plotting to destroy everything in sight. With the help of an agent, the team must find a way to put a stop to the evil plan before it is too late and end up in danger and everyone else in a dilemma that they cannot get out of.
            </p>
    ...
    <div class="reviews">
        ...
        <div id="reviewForm">
            ...
            <section class="left-form" style="width:35%;">
                <img src="/Photos/despicableme2.jpg" style="width:220px;border-radius:20px;margin-top:30px;">
            </section>

            <section class="right-form">
                <h2 style="margin-top: 20px;">I've watched..</h2>
                <h1 style="font-family:Oswald;font-size:35px;font-weight: 700;text-shadow: 1px 1px 1px black;">DESPICABLE ME 2
    ...
    <script>
        ...
        function deleteReview(reviewId) {
                ...
                fetch('delete_despicableme2.php', {
                    method: 'POST',
                    body: params
                })
