...
include 'delete_fastnfurious9.php';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_SESSION['user_id'])) {
        ...
        if (!empty($komentar)) {
            ...
            $query = "INSERT INTO fastfurious9_review (komentar, bintang, user_id) VALUES (:komentar, :bintang, :user_id)";
...
if (isset($_SESSION['user_id'])) {
    $user_id = $_SESSION['user_id'];
    $query = "SELECT er.*, u.username FROM fastfurious9_review er JOIN users u ON er.user_id = u.id ORDER BY er.tanggal DESC";
    $stmt = $conn->prepare($query);
    $stmt->execute();
...
try {
    $avgQuery = "SELECT AVG(bintang) AS rata_rata_bintang FROM fastfurious9_review";
...
<head>
    ...
    <link rel="stylesheet" href="/Film/Fast and Furious 9/fastnfurious9.css">
</head>
...
<header>
    ...
    <div class="main-content">
        ...
        <div class="details">
            ...
            <div class="year">2021, Justin Lin, Daniel Casey,<br> Garry Scott Thompson</div>
            ...
            <br>
            <p class="synopsis">
            F9 is a movie about Vin Diesel’s Dom Toretto, who is leading a quiet life off the grid with Letty and his son, 
            little Brian. However, danger always lurks just over their peaceful horizon, and this time, that threat will force 
            Dom to confront the sins of his past if he’s going to save those he loves most. The movie also features Jack Toretto, Dominic, and Jakob
            </p>
    ...
    <div class="reviews">
        ...
        <div id="reviewForm">
            ...
            <section class="left-form" style="width:35%;">
                <img src="/Photos/F9.jpg" style="width:220px;border-radius:20px;margin-top:30px;">
            </section>

            <section class="right-form">
                <h2 style="margin-top: 20px;">I've watched..</h2>
                <h1 style="font-family:Oswald;font-size:35px;font-weight: 700;text-shadow: 1px 1px 1px black;">FAST AND FURIOUS 9
    ...
    <script>
        ...
        function deleteReview(reviewId) {
                ...
                fetch('delete_fastnfurious9.php', {
                    method: 'POST',
                    body: params
                })
