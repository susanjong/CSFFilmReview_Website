...
include 'delete_minionstheriseofgru.php';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_SESSION['user_id'])) {
        ...
        if (!empty($komentar)) {
            ...
            $query = "INSERT INTO minionstheriseofgru_review (komentar, bintang, user_id) VALUES (:komentar, :bintang, :user_id)";
...
if (isset($_SESSION['user_id'])) {
    $user_id = $_SESSION['user_id'];
    $query = "SELECT er.*, u.username FROM minionstheriseofgru_review er JOIN users u ON er.user_id = u.id ORDER BY er.tanggal DESC";
    $stmt = $conn->prepare($query);
    $stmt->execute();
...
try {
    $avgQuery = "SELECT AVG(bintang) AS rata_rata_bintang FROM minionstheriseofgru_review";
...
<head>
    ...
    <link rel="stylesheet" href="/Film/Minions_The Rise of Gru/minionstheriseofgru.css">
</head>
...
<header>
    ...
    <div class="main-content">
        ...
        <div class="details">
            <h1>MINIONS: <br> THE RISE OF GRU</h1>
            <div class="year">2022, Kyle Balda</div>
            ...
            <br>
            <p class="synopsis">
                The classic movie characters childhood is finally revealed. In the 70's, Gru's big dream was to be a villain. Then he met the minions Light hearted, pill shaped servants. When the Vicious 6 fire there leader, a job opens, leading Gru to his dream. But then Gru is kidnapped, and it's all up to 2015's greatest comedy idiots, Bob,Kevin and Strewart to save Gru, there leader
            </p>
            <div class="genre-tags">
            <a class="btn btn-primary" href="/Genre/Drama.html" role="button">Action</a>
                <a class="btn btn-primary" href="/Genre/Adventure.html" role="button">Adventure</a>
                <a class="btn btn-primary" href="/Genre/Drama.html" role="button">Comedy</a>
            </div>
        </div>
    </div>
    ...
    <div class="reviews">
        ...
        <div id="reviewForm">
            ...
            <section class="left-form" style="width:35%;">
                <img src="/Photos/minions2.jpg" style="width:220px;border-radius:20px;margin-top:30px;">
            </section>

            <section class="right-form">
                <h2 style="margin-top: 20px;">I've watched..</h2>
                <h1 style="font-family:Oswald;font-size:35px;font-weight: 700;text-shadow: 1px 1px 1px black;">MINIONS: THE RISE OF GRU
    ...
    <script>
        ...
        function deleteReview(reviewId) {
                ...
                fetch('delete_minionstheriseofgru.php', {
                    method: 'POST',
                    body: params
                })
