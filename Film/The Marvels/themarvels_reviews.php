...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_SESSION['user_id'])) {
        ...
        if (!empty($komentar)) {
            ...
            $query = "INSERT INTO themarvels_review (komentar, bintang, user_id) VALUES (:komentar, :bintang, :user_id)";
...
if (isset($_SESSION['user_id'])) {
    $user_id = $_SESSION['user_id'];
    $query = "SELECT er.*, u.username FROM themarvels_review er JOIN users u ON er.user_id = u.id ORDER BY er.tanggal DESC";
    $stmt = $conn->prepare($query);
    $stmt->execute();
...
try {
    $avgQuery = "SELECT AVG(bintang) AS rata_rata_bintang FROM themarvels_review";
...
<head>
    ...
    <link rel="stylesheet" href="/Film/The Marvels/themarvels.css">
</head>
...
<header>
    ...
    <div class="main-content">
        ...
        <div class="details">
            <h1>THE MARVELS</h1>
            <div class="year">2023, Nia DaCosta, Elissa <br> Karasik, Megan McDonnell</div>
            ...
            <br>
            <p class="synopsis">
            Carol Danvers (Brie Larson) destroys the Supreme Intelligence, the artificial intelligence that leads the Kree empire. This leads to a civil war and the desolation of the Kree home world, Hala, over the next 30 years. The conflict renders the planet barren as it loses its air, water, and sunlight.
            Dar-Benn (Zawe Ashton), the new leader of the Kree, discovers one of the two legendary Quantum Bands. She harnesses the power of the Band to tear open a jump point, a gateway that allows fast travel across space. The resulting anomaly impacts the entire jump point network, including a jump point near Earth's S.A.B.E.R. (Strategic Aerospace Bio-Physics and Exo-Linguistic Response) space station that is run by Nick Fury (Samuel L. Jackson). 
    ...
    <div class="reviews">
        ...
        <div id="reviewForm">
            ...
            <section class="left-form" style="width:35%;">
                <img src="/Photos/themarvels.webp" style="width:220px;border-radius:20px;margin-top:30px;">
            </section>

            <section class="right-form">
                <h2 style="margin-top: 20px;">I've watched..</h2>
                <h1 style="font-family:Oswald;font-size:35px;font-weight: 700;text-shadow: 1px 1px 1px black;">The Marvels
