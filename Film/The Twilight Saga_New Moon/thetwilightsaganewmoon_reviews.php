...
include 'delete_thetwilightsaganewmoon.php';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_SESSION['user_id'])) {
        ...
        if (!empty($komentar)) {
            ...
            $query = "INSERT INTO thetwilightsaganewmoon_review (komentar, bintang, user_id) VALUES (:komentar, :bintang, :user_id)";
...
if (isset($_SESSION['user_id'])) {
    $user_id = $_SESSION['user_id'];
    $query = "SELECT er.*, u.username FROM thetwilightsaganewmoon_review er JOIN users u ON er.user_id = u.id ORDER BY er.tanggal DESC";
    $stmt = $conn->prepare($query);
    $stmt->execute();
...
try {
    $avgQuery = "SELECT AVG(bintang) AS rata_rata_bintang FROM thetwilightsaganewmoon_review";
...
<head>
    ...
    <link rel="stylesheet" href="/Film/The Twilight Saga_New Moon/thetwilightsaganewmoon.css">
</head>
...
<header>
    ...
    <div class="main-content">
        ...
        <div class="details">
            <h1>THE TWILIGHT SAGA: <br> NEW MOON</h1>
            <div class="year">2009, Chris Weitz</div>
    ...
    <div class="reviews">
        ...
        <div id="reviewForm">
            ...
            <section class="left-form" style="width:35%;">
                <img src="/Photos/twilightnewmoon.jpg" style="width:220px;border-radius:20px;margin-top:30px;">
            </section>

            <section class="right-form">
                <h2 style="margin-top: 20px;">I've watched..</h2>
                <h1 style="font-family:Oswald;font-size:35px;font-weight: 700;text-shadow: 1px 1px 1px black;">THE TWILIGHT SAGA: NEW MOON
    ...
    <script>
        ...
        function deleteReview(reviewId) {
                ...
                fetch('delete_thetwilightsaganewmoon.php', {
                    method: 'POST',
                    body: params
                })
