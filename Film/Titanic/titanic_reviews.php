...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_SESSION['user_id'])) {
        ...
        if (!empty($komentar)) {
            ...
            $query = "INSERT INTO titanic_review (komentar, bintang, user_id) VALUES (:komentar, :bintang, :user_id)";
...
if (isset($_SESSION['user_id'])) {
    $user_id = $_SESSION['user_id'];
    $query = "SELECT er.*, u.username FROM titanic_review er JOIN users u ON er.user_id = u.id ORDER BY er.tanggal DESC";
    $stmt = $conn->prepare($query);
    $stmt->execute();
...
try {
    $avgQuery = "SELECT AVG(bintang) AS rata_rata_bintang FROM titanic_review";
...
<head>
    ...
    <link rel="stylesheet" href="/Film/Titanic/titanic.css">
</head>
...
<header>
    ...
    <div class="main-content">
        ...
        <div class="details">
            <h1>TITANIC </h1>
            <div class="year">1997, James Cameron</div>
            ...
            <br>
            <p class="synopsis">
            In 1996, aboard the research vessel Akademik Mstislav Keldysh, treasure hunter Brock Lovett (Bill Paxton) and his team explore the wreck of RMS Titanic, searching for a valuable diamond necklace called the Heart of the Ocean. The wreck rests on the ocean floor, 3821 meters below the surface. They recover Caledon "Cal" Hockley's (Billy Zane) safe, believing the necklace to be inside, but only find a sketch of a nude woman wearing the diamond, dated April 14, 1912, the night the Titanic hit the iceberg. The expedition is privately funded and hence Brock is under pressure to deliver the diamond to his investors.
    ...
    <div class="reviews">
        ...
        <div id="reviewForm">
            ...
            <section class="left-form" style="width:35%;">
                <img src="/Photos/titanic.jpg" style="width:220px;border-radius:20px;margin-top:30px;">
            </section>

            <section class="right-form">
                <h2 style="margin-top: 20px;">I've watched..</h2>
                <h1 style="font-family:Oswald;font-size:35px;font-weight: 700;text-shadow: 1px 1px 1px black;">Titanic
