...
include 'delete_twilightsaga.php';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_SESSION['user_id'])) {
        ...
        if (!empty($komentar)) {
            ...
            $query = "INSERT INTO thetwilightsaga_review (komentar, bintang, user_id) VALUES (:komentar, :bintang, :user_id)";
...
if (isset($_SESSION['user_id'])) {
    $user_id = $_SESSION['user_id'];
    $query = "SELECT er.*, u.username FROM thetwilightsaga_review er JOIN users u ON er.user_id = u.id ORDER BY er.tanggal DESC";
    $stmt = $conn->prepare($query);
    $stmt->execute();
...
try {
    $avgQuery = "SELECT AVG(bintang) AS rata_rata_bintang FROM thetwilightsaga_review";
...
<head>
    ...
    <link rel="stylesheet" href="/Film/The Twilight Saga- Breaking Dawn Pt 1/twilightsaga.css">
</head>
...
<header>
    ...
    <div class="main-content">
        ...
        <div class="details">
            <h1>THE TWILIGHT <br> SAGA PART 1</h1>
            <div class="year">2011, Bill Condon, Stephenie <br>  Meyer, Melissa Rosenberg</div>
            ...
            <br>
            <p class="synopsis">
            Bella Swan (Kristen Stewart) is getting ready for her wedding. Jacob is livid hearing of their wedding and leaves the house, despite Billy trying to stop him. Meanwhile, Alice takes charge of the wedding itself and prepares Bella for it. Alice loves Bella like a sister. Edward tells Bella that for a few years after Carlisle created him, he went off on his own to hunt for human blood. But all the men he killed were monsters themselves and criminals. Edward says that he took human lives and says that he knows what he is capable of.

That night, Bella has a nightmare that the Volturi are at her wedding, she and Edward are covered in blood, and they are standing on an altar made from the dead bodies of all their wedding guests.
            </p>
            <div class="genre-tags">
                <a class="btn btn-primary" href="/Genre/Romance.html" role="button">Romance</a>
    ...
    <div class="reviews">
        ...
        <div id="reviewForm">
            ...
            <section class="left-form" style="width:35%;">
                <img src="/Photos/twilightpart1.jpg" style="width:220px;border-radius:20px;margin-top:30px;">
            </section>

            <section class="right-form">
                <h2 style="margin-top: 20px;">I've watched..</h2>
                <h1 style="font-family:Oswald;font-size:35px;font-weight: 700;text-shadow: 1px 1px 1px black;">The Twilight Saga Part 1
