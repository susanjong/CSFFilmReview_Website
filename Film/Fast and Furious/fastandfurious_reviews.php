...
include 'delete_fastandfurious.php';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_SESSION['user_id'])) {
        ...
        if (!empty($komentar)) {
            ...
            $query = "INSERT INTO fastfurious_review (komentar, bintang, user_id) VALUES (:komentar, :bintang, :user_id)";
...
if (isset($_SESSION['user_id'])) {
    $user_id = $_SESSION['user_id'];
    $query = "SELECT er.*, u.username FROM fastfurious_review er JOIN users u ON er.user_id = u.id ORDER BY er.tanggal DESC";
    $stmt = $conn->prepare($query);
    $stmt->execute();
...
try {
    $avgQuery = "SELECT AVG(bintang) AS rata_rata_bintang FROM fastfurious_review";
...
<head>
    ...
    <link rel="stylesheet" href="/Film/Fast and Furious/fastandfuious.css">
</head>
<body>
<header>
    ...
    <div class="reviews">
        ...
        <div id="reviewForm">
            ...
            <section class="right-form">
                ...
                <h1 style="font-family:Oswald;font-size:35px;font-weight: 700;text-shadow: 1px 1px 1px black;">FAST AND FURIOUS
    ...
    <script>
        ...
        function deleteReview(reviewId) {
                ...
                fetch('delete_fastandfurious.php', {
                    method: 'POST',
                    body: params
                })
