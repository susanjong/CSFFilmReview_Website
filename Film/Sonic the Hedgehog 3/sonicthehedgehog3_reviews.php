...
include 'delete_sonicthehedgehog3.php';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_SESSION['user_id'])) {
        ...
        if (!empty($komentar)) {
            ...
            $query = "INSERT INTO sonicthehedgehog3_review (komentar, bintang, user_id) VALUES (:komentar, :bintang, :user_id)";
...
if (isset($_SESSION['user_id'])) {
    $user_id = $_SESSION['user_id'];
    $query = "SELECT er.*, u.username FROM sonicthehedgehog3_review er JOIN users u ON er.user_id = u.id ORDER BY er.tanggal DESC";
    $stmt = $conn->prepare($query);
    $stmt->execute();
...
try {
    $avgQuery = "SELECT AVG(bintang) AS rata_rata_bintang FROM sonicthehedgehog3_review";
...
<head>
    ...
    <link rel="stylesheet" href="/Film/Sonic the Hedgehog 3/sonicthehedgehog3.css">
</head>
...
<header>
    ...
    <div class="main-content">
        ...
        <div class="details">
            ...
            <div class="year">2024, Jeff Fowler</div>
    ...
    <div class="reviews">
        ...
        <div id="reviewForm">
            ...
            <section class="left-form" style="width:35%;">
                <img src="/Photos/sonic3.webp" style="width:220px;border-radius:20px;margin-top:30px;">
            </section>

            <section class="right-form">
                <h2 style="margin-top: 20px;">I've watched..</h2>
                <h1 style="font-family:Oswald;font-size:35px;font-weight: 700;text-shadow: 1px 1px 1px black;">SONIC THE HEDGEHOG 3
    ...
    <script>
        ...
        function deleteReview(reviewId) {
                ...
                fetch('delete_sonicthehedgehog3.php', {
                    method: 'POST',
                    body: params
                })
