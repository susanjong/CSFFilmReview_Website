...
include 'delete_thefateofthefurious.php';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_SESSION['user_id'])) {
        ...
        if (!empty($komentar)) {
            ...
            $query = "INSERT INTO thefateofthefurious_review (komentar, bintang, user_id) VALUES (:komentar, :bintang, :user_id)";
...
if (isset($_SESSION['user_id'])) {
    $user_id = $_SESSION['user_id'];
    $query = "SELECT er.*, u.username FROM thefateofthefurious_review er JOIN users u ON er.user_id = u.id ORDER BY er.tanggal DESC";
    $stmt = $conn->prepare($query);
    $stmt->execute();
...
try {
    $avgQuery = "SELECT AVG(bintang) AS rata_rata_bintang FROM thefateofthefurious_review";
...
<head>
    ...
    <link rel="stylesheet" href="/Film/The Fate of the Furious/thefateofthefurious.css">
</head>
...
<header>
    ...
    <div class="main-content">
        ...
        <div class="details">
            <h1>THE FATE OF<br> THE FURIOUS</h1>
            <div class="year">2017, F.Gary Gray</div>
            ...
            <br>
            <p class="synopsis">
                The family has been doing their normal thing. Everything has been cool with them as it always has. All of a sudden, a mysterious decoy (woman) lured Dominic Toretto (Vin Diesel) and enthralled him to the state of betrayal. He betrayed his family and set them to face trials they never imagined to face alone without Dom.
            </p>
    ...
    <div class="reviews">
        ...
        <div id="reviewForm">
            ...
            <section class="left-form" style="width:35%;">
                <img src="/Photos/f8.jpg" style="width:220px;border-radius:20px;margin-top:30px;">
            </section>

            <section class="right-form">
                <h2 style="margin-top: 20px;">I've watched..</h2>
                <h1 style="font-family:Oswald;font-size:35px;font-weight: 700;text-shadow: 1px 1px 1px black;">THE FATE OF THE FURIOUS
    ...
    <script>
        ...
        function deleteReview(reviewId) {
                ...
                fetch('delete_thefateofthefurious.php', {
                    method: 'POST',
                    body: params
                })
